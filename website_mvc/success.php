 ...
 <div class="main">
    <div class="content">
    	<div class="section group">
            ...
            ?>
            <p>Tổng giá trị bạn đã mua: <?php $total =$amount*0.1 + $amount; echo $fm->format_currency($total);  ?> VNĐ</p>
            <p>Chúng tôi sẽ liên hệ với bạn sớm nhất có thể, xem chi tiết đặt hàng tại đây.<a href="orderdetails.php">Click vào đây</a></p>
...
$output .= '
<tr><td colspan="5" align="center"></td></tr>
<tr><td colspan="5"  style="background-color: #42c9db">Đơn vị bán hàng: Nhóm 3</td></tr> 
<tr><td colspan="5" >Mã số thuế: 1512359</td></tr> 
<tr><td colspan="5" >Địa chỉ: Trần Hưng Đạo-TP Nam Định</td></tr> 
